module.exports = {
    ...
    run: async (interaction, client) => {
        try {
                            ...
                            components: [
                                {
                                    ...
                                    emoji: {
                                        name: '${global.config.server.emojis.success}'
                                    }
                                },
                                {
                                    type: 2,
                                    ...
                                    emoji: {
                                        name: '${global.config.server.emojis.error}'
                                    }
                                }
                            ]
                        }
            ...
            console.log(err);
            interaction.reply({ content: 'An error occurred while using the delete command. ```bash\n' + err + '```' });
        }
    }
}